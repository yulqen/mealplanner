...
- [ ] Every item on the shopping list needs a button to allow the user to move the
    ...
    - The button to trigger this should be similar to the move and star icons on
        the list and should look appropriate
- [ ] The ".. checked items cleared" message on the shopping list page needs to be a
    toast so that it goes away automatically
- [ ]Sometimes when manually add an item to a shopping list and click Add Item, it
    gets added to the list but the text stays in the Item box.
